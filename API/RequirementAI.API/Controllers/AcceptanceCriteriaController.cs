    ...
    : RequirementAIControllerBase
{
    ...
    {
        var result = await acceptanceCriteriaService.GetById(id, ct);
    ...
    {
        var result = await acceptanceCriteriaService.GetByUserStoryId(userStoryId, ct);
    ...
    {
        var result = await acceptanceCriteriaService.Create(dto, ct);
        return Ok(ResponseDto<AcceptanceCriteriaResponseDto>.Success(result));
    }
    ...
    {
        await acceptanceCriteriaService.Update(dto, ct);
    ...
    {
        await acceptanceCriteriaService.Delete(id, ct);
        return Ok(ResponseDto.Success());
    }
}