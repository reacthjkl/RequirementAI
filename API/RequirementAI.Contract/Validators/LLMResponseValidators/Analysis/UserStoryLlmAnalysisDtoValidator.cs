...
public class UserStoryLlmAnalysisDtoValidator: AbstractValidator<UserStoryLlmAnalysisDto>
{
    public UserStoryLlmAnalysisDtoValidator()
    {
        ...
        RuleFor(x => x.AcceptanceCriteriaScore).GreaterThan(0).LessThan(10).NotEmpty();
        RuleFor(x => x.ScopeScore).GreaterThan(0).LessThan(10).NotEmpty();
        RuleFor(x => x.BusinessValueScore).GreaterThan(0).LessThan(10).NotEmpty();
        RuleFor(x => x.AmbiguityScore).GreaterThan(0).LessThan(10).NotEmpty();
    }
}