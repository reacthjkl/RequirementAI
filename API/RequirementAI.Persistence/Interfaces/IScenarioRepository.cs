...
public interface IScenarioRepository
{
    ...
    Task<Scenario> GetById(Guid id, Guid organizationId, CancellationToken ct);
    Task<IList<Scenario>> GetByPersona(Guid personaId, CancellationToken ct);
    Task<IList<Scenario>> GetByPersona(Guid personaId, Guid organizationId, CancellationToken ct);
