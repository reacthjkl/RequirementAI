    ...
    : RequirementAIControllerBase
{
    ...
    {
        var result = await userStoryService.GetById(id, ct);
    ...
    {
        var result = await userStoryService.GetByScenarioId(scenarioId, ct);
    ...
    {
        var result = await userStoryService.GetByPersonaId(personaId, ct);
        return Ok(ResponseDto<List<UserStoryResponseDto>>.Success(result));
    }
    ...
    {
        var result = await userStoryService.GetByProject(projectId, ct);
        return Ok(ResponseDto<List<UserStoryResponseDto>>.Success(result));
    }
    ...
    {
        var result = await userStoryService.Create(dto, ct);
        return Ok(ResponseDto<UserStoryResponseDto>.Success(result));
    }
    ...
    {
        await userStoryService.Update(dto, ct);
    ...
    {
        await userStoryService.Delete(id, ct);
        return Ok(ResponseDto.Success());
    }
}